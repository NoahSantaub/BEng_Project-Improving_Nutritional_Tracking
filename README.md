...
### TO DO:
  - Implement calorie API
  - MORE COMPLEX: Automate entire process
...
The initial concept used image recognition to identify the food in the image; however, it was found to be the wrong approach, and object detection should be used.
...
Using YOLO architecture, fruit is quickly identified to varying degrees of accuracy. 

Further work on transfer learning and dataset optimisation is required. 
Datasets tested, YOLO pretrained, COCO, OpenImages V7, LVIS, either located from propriety sites, Kaggle or FiftyOne (https://docs.voxel51.com/index.html# // https://docs.voxel51.com/dataset_zoo/datasets.html)

USE objectDetectionYOLO_02_MultipleObject.py (functions the same as objectDetectionYOLO_0_SingleObject.py)
  It takes in an image/frame -> resizes and formats it -> calls a pre-trained model -> Outputs: Class name & prediction confidence
